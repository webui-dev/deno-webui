...
import { WebUI } from "jsr:@webui/deno-webui@2.5.10"; // import {WebUI} from "https://deno.land/x/webui@2.5.10/mod.ts";
...
// Show the window
await myWindow.showBrowser(myHtml, WebUI.Browser.AnyBrowser); // Or await myWindow.show('./myFile.html');
