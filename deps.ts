...
} from "https://ejm.sh/raw.githubusercontent.com/webui-dev/deno-webui/2930d88868a629ecc07d48320489fa0dc1b7fe1d/src/webui-2-x64.dll" assert {
  type: "json",
};
export {
  //@ts-ignore ejm serve { b64: string }
  default as webui2Linux,
} from "https://ejm.sh/raw.githubusercontent.com/webui-dev/deno-webui/2930d88868a629ecc07d48320489fa0dc1b7fe1d/src/webui-2-x64.so" assert {
  type: "json",
};
